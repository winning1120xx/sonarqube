...
public class WsTaskFormater {

  private final ComponentService componentService;

  public WsTaskFormater(ComponentService componentService) {
    this.componentService = componentService;
  }

  public WsCe.TaskResponse format(CeQueueDto dto) {
    WsCe.TaskResponse.Builder builder = WsCe.TaskResponse.newBuilder();
  ...
  public WsCe.TaskResponse format(CeActivityDto dto) {
    WsCe.TaskResponse.Builder builder = WsCe.TaskResponse.newBuilder();
    builder.setId(dto.getUuid());
    builder.setStatus(WsCe.TaskStatus.valueOf(dto.getStatus().name()));
    builder.setTaskType(dto.getTaskType());
  ...
  private void buildComponent(WsCe.TaskResponse.Builder builder, String componentUuid) {
