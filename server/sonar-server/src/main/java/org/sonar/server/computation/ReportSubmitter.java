...
public class ReportSubmitter {
  ...
  public CeTask submit(String projectKey, @Nullable String branch, @Nullable String projectName, InputStream reportInput) {
    // check project
    ...
    // save report before submitting the task
